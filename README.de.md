...
- **API-Schlüssel erforderlich**: Setze `OPENROUTER_API_KEY` oder `OPENAI_API_KEY` in deinen Umgebungsvariablen. Für Tests sind kostenlose OpenRouter-Modelle verfügbar.
